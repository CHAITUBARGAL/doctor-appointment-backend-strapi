...
export interface ApiCatogorieCatogorie extends Schema.CollectionType {
  collectionName: 'catogories';
  info: {
    singularName: 'catogorie';
    pluralName: 'catogories';
    displayName: 'Catogories';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    experiences: Attribute.String & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::catogorie.catogorie': ApiCatogorieCatogorie;
